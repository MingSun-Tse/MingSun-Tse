...
🔥 NEWS: Check out preprint work that deciphers the confusing benchmark situation in neural network (filter) pruning: [Confusing-Pruning](https://github.com/mingsun-tse/why-the-state-of-pruning-so-confusing) <br/>
